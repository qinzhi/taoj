    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-sky" style="padding: 15px 11px">
                <a class="btn btn-success" id="add_position" href="javascript:void(0);">添加</a>
                <a class="btn btn-success" id="update_position" href="javascript:void(0);">保存</a>
                <span> | </span>
                <a class="btn btn-danger" id="del_position" href="javascript:void(0);">删除</a>
            </div><!--Widget Header-->
            <div class="widget-body plugins_position-">
                <div class="row">
                    <div class="col-xs-6 col-md-4">
                        <div class="well">
                            <table class="table table-bordered table-condensed table-hover table-focus">
                                ...
                                <tbody>
                                    <?php if(is_array($position)): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-node="<?php echo ($vo["id"]); ?>">
                                            <td>
                                                <?php echo ($vo["name"]); ?>
                                            </td>
                                            <td>
                            ...
                            <!--<div class="row DTTTFooter">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="dataTables_paginate paging_bootstrap pull-right" id="editabledatatable_paginate" style="padding-top: 10px;">
                                        <ul class="pagination">
