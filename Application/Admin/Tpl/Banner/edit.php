                ...
                <div id="horizontal-form">
                    <form role="form" class="form-horizontal" style="margin: 30px 0;" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group input-group-sm">
                                    <input type="text" name="image" id="image" class="form-control" value="{$banner.image}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="intro" name="intro" value="{$banner.intro}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right" for="sort">排序</label>
                            <div class="col-sm-6">
                                <input type="text" id="sort" name="sort" value="{$banner.sort}"  class="form-control">
                            </div>
                        </div>
