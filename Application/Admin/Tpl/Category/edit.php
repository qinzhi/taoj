                ...
                <div id="horizontal-form">
                    <form role="form" method="post" class="col-md-8 form-horizontal" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11 row">
                                <div class="col-xs-12 col-md-6">
                                    <input type="text" id="p_name" name="p_name" class="form-control" value="{$p_name}" disabled>
                                    <input type="hidden" id="p_id" name="p_id" class="form-control" value="0" value="{$category.pid}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-11 row">
                                <div class="col-xs-12 col-md-6">
                                    <input type="text" id="intro" name="intro" class="form-control" value="{$category.intro}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-11 row">
                                <div class="col-xs-12 col-md-6">
                                    <input type="text" id="sort" name="sort" class="form-control" value="{$category.sort}">
                                </div>
                            </div>
                        </div>
                    </form>
