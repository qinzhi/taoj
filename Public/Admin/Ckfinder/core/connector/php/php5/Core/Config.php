...
class CKFinder_Connector_Core_Config
{
     ...
     * 资源根目录
     */
    private $_resource_root_dir = '';
    /**
     * 会员空间大小
     */
    private $_resource_space_size = array();
    /**
     * Is CKFinder enabled
     *
     * @var boolean
    ...
    /**
     * Get Resource_Space_Size
     *
     * @access public
     * @return string
     */
    public function getResource_Space_Size()
    {
        return $this->_resource_space_size;
    }

    /**
     * Get Resource_Root_Dir
     *
     * @access public
     * @return string
     */
    public function getResource_Root_Dir()
    {
        return $this->_resource_root_dir;
    }
