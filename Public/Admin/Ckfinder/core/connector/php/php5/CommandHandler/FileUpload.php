...
class CKFinder_Connector_CommandHandler_FileUpload extends CKFinder_Connector_CommandHandler_CommandHandlerBase
{
    ...
    public function sendResponse()
    {
        ...
        if (!isset($uploadedFile['name'])) {
            $uploadedFile['name'] = iconv('utf-8','gbk', $uploadedFile['name']);
        ...
        //判断资源空间大小是否超过最大值
        /*if(!$_resourceTypeConfig->checkResourceSpaceSize()){
            $this->_errorHandler->throwError(CKFINDER_CONNECTOR_ERROR_RESOURCE_SIZE);
        }*/
